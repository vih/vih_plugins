...
<div class="layout-2col clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <?php if ($content['contentmain1_left'] || $content['contentmain1_right']): ?>
    <div class="container">
      <div class="row">
        <div class="col-md-8 panel-pane-region panel-pane-region-contentmain1-left">
          <?php print $content['contentmain1_left']; ?>
        </div>
        <div class="col-md-4 panel-pane-region panel-pane-region-contentmain1-right">
  ...
  <?php if ($content['fullwidth3']): ?>
    <div class="panel-pane-region panel-region-full-width panel-region-full-width-3">
      <div class="panel-region-inner">
  ...
  <?php if ($content['contentmain4_left'] || $content['contentmain4_right']): ?>
    <div class="container">
      <div class="row">
        <div class="col-md-6 panel-pane-region panel-pane-region-contentmain4-left">
          <?php print $content['contentmain4_left']; ?>
        </div>
        <div class="col-md-6 panel-pane-region panel-pane-region-contentmain4-right">
